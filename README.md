...
1. What is the DOM?
DOM is Document Object Model which represents html elements of a webpage.

2. What is an event?
Event is how users interact with the page.

3. What is an event listener?
Event listener is when a object handles a event from eventTarget object.

4. Why would we convert a NodeList into an Array?
We should convert a Nodelist into an array because nodelist can't use array methods needed to be used
to manipulate data or information.

5. What is a component?
Component is reusable piece of code that's used to create elements.
